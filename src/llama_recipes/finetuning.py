...
def main(**kwargs):
    ...
    dt = (results["avg_epoch_time"] - results["avg_checkpoint_time"]) / len(train_dataloader)
    mfus = estimate_mfu(train_config.model_name, num_params, train_config.batch_size_training, dt, 'H100')
